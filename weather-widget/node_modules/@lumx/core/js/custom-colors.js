...
/* harmony import */ var core_js_modules_es_object_entries__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(111);
...
function generateCSSColorVariables(palette) {
  ...
  for (var _i = 0, _Object$entries = Object.entries(palette); _i < _Object$entries.length; _i++) {
    var _Object$entries$_i = _Object$entries[_i],
        color = _Object$entries$_i[0],
        variants = _Object$entries$_i[1];
    if (!variants) continue;

    for (var _i2 = 0, _Object$entries2 = Object.entries(variants); _i2 < _Object$entries2.length; _i2++) {
